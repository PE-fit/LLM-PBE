...
def parse_args():
    ...
    parser.add_argument(
        "--dev_file", default=None, type=str, help="The input evaluation file."
    )  # from echr
    parser.add_argument(
        "--test_file", default=None, type=str, help="The input testing file."
    )
    ...
    parser.add_argument(
        "--do_evaluate",
        action="store_true",
        help="Whether to evaluate differences between 2 models.",
    )
    ...
    parser.add_argument(
        ...
        default=2,
        type=int,
        help="Accumulate gradients before updating.",
    )
