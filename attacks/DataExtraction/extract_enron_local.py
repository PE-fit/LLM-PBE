...
parser.add_argument(
    "--num_sample", default=-1, type=int, help="use -1 to include all samples"
)
parser.add_argument(
    "--model", default="./results/llama-2-7B-enron/checkpoint_451", type=str
)
...
for i, prompt in enumerate(tqdm(prompts)):
    ...
    try:
        ...
        result.append(
            {"idx": i, "output": res, "label": ground_truth, "prompt": prompt}
        )
